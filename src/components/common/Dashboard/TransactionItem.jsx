    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className={`w-10 h-10 bg-gradient-to-br ${transaction.type === 'Expense' ? getExpenseColor(transaction.category) : 'from-green-500 to-green-600'} rounded-lg flex items-center justify-center shadow-sm`}>
